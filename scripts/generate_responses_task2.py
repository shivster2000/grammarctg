...
output_file = f'../data/task2/{args.output_file.replace("%model%", args.label if args.label else args.model)}'
input_file = f'../data/task2/{args.input_file}'
...
def get_responses(case):
    case = helpers.get_prompt_task_2(case, **kwargs)
